# PRACTICE NEXT AUTH JS WITH PRISMA AND POSTGRESQL
...
### Dashboard Page: app\dashboard\page.tsx (Client Component)

![dashboard page image](public/images/readme/app-image-02.jpg 'Dashboard Page')

### Dashboard 2 Page: app\dashboard2\page.tsx (Server Component)

![dashboard 2 page image](public/images/readme/app-image-03.jpg 'Dashboard 2 Page')

### Dashboard 3 Page: app\dashboard3\page.tsx (Server Component)

![dashboard 3 page image](public/images/readme/app-image-04.jpg 'Dashboard 3 Page')

### Auth Signin (Credentials Provider): localhost:3000/api/auth/signin

![auth signin image](public/images/readme/app-image-05.jpg 'auth signin')
...
1. Clone the repository: https://github.com/newmanferrer/practice-250423-next-auth-01.git
...
Practice date: 25/04/2023

Application review date: 27/04/2023
